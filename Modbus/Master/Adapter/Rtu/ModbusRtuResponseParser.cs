...
internal static class ModbusRtuResponseParser
{
    public static FilterResult Filter<TReader>(ref TReader reader, ref ModbusRtuResponse request, ModbusFunctionHandlerRegistry registry)
        where TReader : IBytesReader
    {
        ...
        if (isError)
        {
            ...
            request = new ModbusRtuResponse()
            {
                ...
                ResponseMemory = reader.TotalSequence.Slice(pos, reader.BytesRead - pos).ToArray()
            };
